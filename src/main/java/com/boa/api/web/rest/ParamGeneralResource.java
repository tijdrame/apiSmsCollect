...
public class ParamGeneralResource {
    ...
    public ResponseEntity<ParamGeneral> updateParamGeneral(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, paramGeneral.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<ParamGeneral> partialUpdateParamGeneral(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, paramGeneral.getId().toString())
        );
    }
